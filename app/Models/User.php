...
class User extends Authenticatable
{
     ...
     * $this->attributes['email'] - string - contains user email
     ...
     * $this->attributes['role'] - string - contains the role (client or admin)
     * $this->attributes['balance'] - int - contains the user balance
     * $this->attributes['created_at'] - timestamp - contains the user creation date
     * $this->attributes['updated_at'] - timestamp - contains the user update time
